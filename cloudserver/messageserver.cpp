...
//{
//    nextBlockSize=0;
//    qDebug()<<"make a Message MySocket."<<QThread::currentThreadId();
...
//        if(nextBlockSize==0&&bytesAvailable()>=sizeof (quint64)) in>>nextBlockSize;
//        if(bytesAvailable()<nextBlockSize||nextBlockSize==0) return;
...
//{
//    qDebug()<<"make a message MyThread."<<QThread::currentThreadId();
//}
...
//{
//    qDebug()<<"a new message connection comming";
...
//}
//void MyServer::MyServerSlot_saveANO()
//{
//    qDebug()<<"saveANO";//need to be done
//}
